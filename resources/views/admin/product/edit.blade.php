                            ...
                            <div class="row" id="product-gallery">
                                @foreach ($productImages as $image)
                                    <div class="mt-2" id="image-row-{{ $image->id }}" style="width: 18rem;">
                                        ...
                                        <img src="{{ asset('uploads/product/large/' . $image->image) }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    ...
                                    <input type="checkbox" name="track_qty" id="track_qty" value="Yes"
                                        class="form-check-input" {{ $product->track_qty == 'Yes' ? 'checked' : '' }}>
                                    <label for="track_qty" class="form-check-label">Track Quantity</label>
                                    <input type="text" name="qty" id="qty" class="form-control mt-2"
