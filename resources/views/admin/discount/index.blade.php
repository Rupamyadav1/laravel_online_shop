            ...
            <div class="card">
                <div class="card-header border-bottom card-tabs d-flex flex-wrap align-items-center gap-2">
                    ...
                    <div class="d-flex flex-wrap flex-lg-nowrap gap-2">
                        ...
                        <a href="{{ route('discount.create') }}" class="btn btn-primary"><i class="ri-add-line me-1"></i>Add
                            Discount</a>
                    </div><!-- end d-flex -->
                </div>
                    ...
                    <table class="table table-hover text-nowrap mb-0">
                        <thead class="bg-light-subtle">
                            <tr>
                                ...
                                <th class="fs-12 text-uppercase text-muted">Code</th>
                                <th class="fs-12 text-uppercase text-muted">Name </th>
                                <th class="fs-12 text-uppercase text-muted">Type </th>
                                <th class="fs-12 text-uppercase text-muted">Discount starts</th>
                                <th class="fs-12 text-uppercase text-muted">Discount ends </th>
                            ...
                            @if (!empty($discounts))
                                @foreach ($discounts as $discount)
                                    <tr>
                                        ...
                                        <td><span class="fs-15 text-muted">{{ $discount->code }}</span></td>
                                        ...
                                        @else
                                            <td>
                                                <span class="badge bg-success-subtle text-success fs-12 p-1">Not
                                                    Confirmed</span>
                                            </td>
                                        @endif
                                        ...
                                        <td class="pe-3">
                                            <div class="hstack gap-1 justify-content-end">
                                                ...
                                                <a onclick="deleteDiscount({{ $discount->id }})"
...
@section('customJS')
    <script>
        function deleteDiscount(id) {
            ...
            var url = "{{ route('discount.delete','ID')}}"; // 'ID' is just a placeholder
