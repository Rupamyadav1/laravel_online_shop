                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" name="max_uses" id="max_uses"
                            ...
                            <div class="col">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" name="max_user_uses" id="max_user_uses"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" name="ends_at" id="ends_at"
                                        placeholder="Ends At">
                                        <p></p>
                                </div>
                            </div>
