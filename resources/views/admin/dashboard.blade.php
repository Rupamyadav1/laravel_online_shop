            ...
            <div class="card-body px-0 pt-0">
                <div class="border-top border-bottom border-light border-dashed">
                    <div class="row text-center align-items-center">
                        ...
                        <div class="col-md-3 col-6">
                            <img src="{{asset('admin_assets/images/cards/american-express.svg')}}" alt="user-card"
                                height="36" />
                            <img src="{{asset('admin_assets/images/cards/discover-card.svg')}}" alt="user-card"
                                height="36" />
                            <img src="{{asset('admin_assets/images/cards/mastercard.svg')}}" alt="user-card" height="36" />
                        </div>
                    </div>
                </div>
