...
<!-- Mirrored from canvastemplate.com/index-corporate.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Apr 2025 09:29:47 GMT -->
...
<head>
	...
	<!-- Font Icons -->
	<link rel="stylesheet" href="{{asset('front_assets/css/font-icons.css')}}">

	<!-- SLIDER REVOLUTION 5.x CSS SETTINGS -->
	<link rel="stylesheet" href="{{asset('front_assets/include/rs-plugin/css/settings.css')}}" media="screen">
	<link rel="stylesheet" href="{{asset('front_assets/include/rs-plugin/css/layers.css')}}">
	<link rel="stylesheet" href="{{asset('front_assets/include/rs-plugin/css/navigation.css')}}">
...
<body class="stretched">
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
											...
											<div class="mega-menu-content">
												<div class="row mx-0">
													<ul class="sub-menu-container mega-menu-column col">
														...
														<li class="menu-item">
															<a class="menu-link" href="{{asset('front_assets/menu-2.html')}}"><div>Alternate Layout</div></a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="{{asset('front_assets/menu-3.html')}}"><div>Pill Style</div></a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="{{asset('front_assets/menu-4.html')}}"><div>Border Style</div></a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="{{asset('front_assets/menu-5.html')}}"><div>Large Icon Menu</div></a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="{{asset('front_assets/split-menu.html')}}"><div>Split Layout 1</div></a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="{{asset('front_assets/split-menu-2.html')}}"><div>Split Layout 2</div></a>
														</li>
														<li class="menu-item">
															<a class="menu-link" href="{{asset('front_assets/menu-10.html')}}"><div>Overlay Menu</div></a>
														</li>
													</ul>
													<ul class="sub-menu-container mega-menu-column col">
														<li class="menu-item">
						...
						<form class="top-search-form" action="https://canvastemplate.com/search.html" method="get">
		...
		<section id="slider" class="slider-element revslider-wrap slider-parallax min-vh-100 include-header">
			<div class="slider-inner">
				<div id="rev_slider_579_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="default-slider" style="padding:0px;">
					...
					<h1>i will insert here an image related to my project</h1>
				...
				<div class="section mb-0">
					<div class="container">
						...
						<div class="subscribe-widget">
							...
							<form id="widget-subscribe-form2" action="https://canvastemplate.com/include/subscribe.php" method="post" class="mb-0">
							...
							<div class="row col-mb-50">
								...
								<div class="col-md-5 col-lg-12">
									<div class="widget subscribe-widget">
										...
										<div class="widget-subscribe-form-result"></div>
										<form id="widget-subscribe-form" action="https://canvastemplate.com/include/subscribe.php" method="post" class="mb-0">
	...
	<script src="{{asset('front_assets/js/functions.bundle.js')}}"></script>

	<!-- SLIDER REVOLUTION 5.x SCRIPTS  -->
	<script src="{{asset('front_assets/include/rs-plugin/js/jquery.themepunch.tools.min.js')}}"></script>
	<script src="{{asset('front_assets/include/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>

	<script src="{{asset('front_assets/include/rs-plugin/js/extensions/revolution.extension.video.min.js')}}"></script>
	<script src="{{asset('front_assets/include/rs-plugin/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
	<script src="{{asset('front_assets/include/rs-plugin/js/extensions/revolution.extension.actions.min.js')}}"></script>
	<script src="{{asset('front_assets/include/rs-plugin/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
	<script src="{{asset('front_assets/include/rs-plugin/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
	<script src="{{asset('front_assets/include/rs-plugin/js/extensions/revolution.extension.navigation.min.js')}}"></script>
	<script src="{{asset('front_assets/include/rs-plugin/js/extensions/revolution.extension.migration.min.js')}}"></script>
	<script src="{{asset('front_assets/include/rs-plugin/js/extensions/revolution.extension.parallax.min.js')}}"></script>
...
<!-- Mirrored from canvastemplate.com/index-corporate.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Apr 2025 09:31:59 GMT -->
</html>