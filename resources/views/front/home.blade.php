...
<!-- Mirrored from team90degree.com/html/tf/bestshop-new-demo/bestshop-demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Apr 2025 03:07:50 GMT -->
					...
					<div class="product-list-sliderd">
						<ul class="swiper-wrappers product-list product-list-vertical">
							<li class="swiper-slidess text-center"> 
								...
								<a href="#" data-target="#product-01" data-toggle="modal">
									<span class="product-list-right pull-left">
										<span class="product-list-name h4 black-color">Winter Long Sleeve Black White </span>
							...
							<li class="swiper-slidess text-center"> 
								...
								<a href="#" data-target="#product-01" data-toggle="modal">
									<span class="product-list-right pull-left">
										<span class="product-list-name h4 black-color">women totes lady handbag</span>
							...
							<li class="swiper-slidess text-center"> 
								...
								<a href="#" data-target="#product-01" data-toggle="modal">
									<span class="product-list-right pull-left">
										<span class="product-list-name h4 black-color">Lace water soluble sexy dress</span>
							...
							<li class="swiper-slidess  text-center" > 
								...
								<a href="#" data-target="#product-01" data-toggle="modal">
									<span class="product-list-right pull-left">
										<span class="product-list-name h4 black-color">Elegant Formal Party Dress</span>
							...
							<li class="swiper-slidess text-center"> 
								...
								<a href="#" data-target="#product-01" data-toggle="modal">
									<span class="product-list-right pull-left">
										<span class="product-list-name h4 black-color">Mini Dress Ladies Sleeve</span>
										<span class="product-list-price">$600.00</span>
										<span class="product-list-price sell-p"><del>$700.00</del></span>
									</span>
								</a> 
						...
						<div class="product-list-slider">
							<ul class="swiper-wrapper product-list product-list-vertical">
								<li class="swiper-slide text-center"> 
									...
									<a href="#" data-target="#product-01" data-toggle="modal">
										<span class="product-list-right pull-left">
											<span class="product-list-name h4 black-color">women white backless mini</span>
											<span class="product-list-price">$400.00</span>
											<span class="product-list-price sell-p"><del>$580.00</del></span>
										</span>
									</a> 
								...
								<li class="swiper-slide text-center"> 
									...
									<a href="#" data-target="#product-01" data-toggle="modal">
										<span class="product-list-right pull-left">
											<span class="product-list-name h4 black-color">Sexy Women Floral Embroidery</span>
											<span class="product-list-price">$600.00</span>
										</span>
									</a> 
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<p>Lorem ipsum dolor sit amet  eiusmod tempor incididunt ut labore et dolore magna aliqua. consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitatio ex eatikre commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatuor. Excepteur sint occaecat cupidataproident, sunt in culpa qui officiad est laboincididunt ut labore et dolore magna aliqua.  eiusmeiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="contact-data">
						...
						<ul>
							...
							<li><span class="ti-map-alt icon"></span>201 Oak Street Building 27 <br> Manchester, USA</li>
						</ul>
					</div>
					<div class="contact-data">
						<h4>Australia</h4>
				...
				<div class="col-md-8 col-md-push-1">
					<div class="contact-form">
						<form  class="contact-forms" id="contact-form" action="https://team90degree.com/html/tf/bestshop-new-demo/bestshop-demo/mail.php" method="post">
